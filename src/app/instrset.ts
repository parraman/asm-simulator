...
export enum OpCode {
    ...
    MOV_ADDRESS_TO_REG16 = 2,
    MOV_REGADDRESS_TO_REG16 = 3,
    MOV_REG16_TO_ADDRESS = 4,
    MOV_REG16_TO_REGADDRESS = 5,
    MOV_WORD_TO_REG16 = 6,
    MOV_WORD_TO_ADDRESS = 7,
    MOV_WORD_TO_REGADDRESS = 8,
    MOVB_REG8_TO_REG8 = 9,
    MOVB_ADDRESS_TO_REG8 = 10,
    MOVB_REGADDRESS_TO_REG8 = 11,
    MOVB_REG8_TO_ADDRESS = 12,
    MOVB_REG8_TO_REGADDRESS = 13,
    MOVB_BYTE_TO_REG8 = 14,
    MOVB_BYTE_TO_ADDRESS = 15,
    MOVB_BYTE_TO_REGADDRESS = 16,
